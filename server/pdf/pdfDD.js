                    ...
                    table: {
                        ...
                        body: [
                            ...
                            },
                            {
                                border: [false, false, false, true],
                                text: {
                                    text: props.began ? formatDate(props.began.toISOString().split("T")[0]) : '', fontSize: 9, lineHeight: 0.1
                                }
                            },
                            {
                                border: [false, false, false, false],
                ...
                table: {
                    ...
                    body: [
                        ...
                        [
                            ...
                            { // row 2
                                text: props.herdInfo.milk_cows ? props.herdInfo.milk_cows[0] : ''
                            },
                            { // row 2
                                text: props.herdInfo.dry_cows ? props.herdInfo.dry_cows[0] : ''
                            },
                            { // row 2
                                text: props.herdInfo.bred_cows ? props.herdInfo.bred_cows[0] : ''
                            },
                            { // row 2
                                text: props.herdInfo.cows ? props.herdInfo.cows[0] : ''
                            },
                            { // row 2
                                text: props.herdInfo.calf_old ? props.herdInfo.calf_old[0] : ''
                            },
                            { // row 2
                                text: props.herdInfo.calf_young ? props.herdInfo.calf_young[0] : ''
                            },
                        ...
                        [
                            ...
                            { // row 2
                                text: props.herdInfo.milk_cows ? props.herdInfo.milk_cows[1] : ''
                            },
                            { // row 2
                                text: props.herdInfo.dry_cows ? props.herdInfo.dry_cows[1] : ''
                            },
                            { // row 2
                                text: props.herdInfo.bred_cows ? props.herdInfo.bred_cows[1] : ''
                            },
                            { // row 2
                                text: props.herdInfo.cows ? props.herdInfo.cows[1] : ''
                            },
                            { // row 2
                                text: props.herdInfo.calf_old ? props.herdInfo.calf_old[1] : ''
                            },
                            { // row 2
                                text: props.herdInfo.calf_young ? props.herdInfo.calf_young[1] : ''
                            },
                        ...
                        [
                            ...
                            { // row 
                                text: props.herdInfo.milk_cows ? props.herdInfo.milk_cows[2] : ''
                            },
                            { // row 
                                text: props.herdInfo.dry_cows ? props.herdInfo.dry_cows[2] : ''
                            },
                            { // row 
                                text: props.herdInfo.bred_cows ? props.herdInfo.bred_cows[2] : ''
                            },
                            { // row 
                                text: props.herdInfo.cows ? props.herdInfo.cows[2] : ''
                            },
                            { // row 
                                text: props.herdInfo.calf_old ? props.herdInfo.calf_old[2] : ''
                            },
                            { // row 
                                text: props.herdInfo.calf_young ? props.herdInfo.calf_young[2] : ''
                            },
                        ...
                        [
                            ...
                            { // row 
                                text: props.herdInfo.milk_cows ? props.herdInfo.milk_cows[3] : ''
                            },
                            { // row 
                                text: props.herdInfo.dry_cows ? props.herdInfo.dry_cows[3] : ''
                            },
                            { // row 
                                text: props.herdInfo.bred_cows ? props.herdInfo.bred_cows[3] : ''
                            },
                            { // row 
                                text: props.herdInfo.cows ? props.herdInfo.cows[3] : ''
                            },
                            { // row 
                                text: props.herdInfo.calf_old ? props.herdInfo.calf_old[3] : ''
                            },
                            { // row 
                                text: props.herdInfo.calf_young ? props.herdInfo.calf_young[3] : ''
                            },
                        ...
                        [
                            ...
                            { // row 
                                text: props.herdInfo.milk_cows ? props.herdInfo.milk_cows[4] : ''
                            },
                            { // row 
                                text: props.herdInfo.dry_cows ? props.herdInfo.dry_cows[4] : ''
                            },
                            { // row 
                                text: props.herdInfo.bred_cows ? props.herdInfo.bred_cows[4] : ''
                            },
                            { // row 
                                text: props.herdInfo.cows ? props.herdInfo.cows[4] : ''
                            },
                            { // row 6
                                fillColor: darkGray,
                    ...
                    body: [
                        [
                            ...
                            },
                            {
                                border: [false, false, false, true],
                                text: {
                                    text: props.herdInfo.milk_cows ? props.herdInfo.milk_cows[5] : '', alignment: 'right', fontSize: 9
                                }
                            },
                            {
...
const availableNutrientsB = (props) => {
    ...
    let numCows = props.herdCalc[1] ? props.herdCalc[1].replaceAll(',', '') : '0'
    let n_ammonia_loss = (parseFloat(numCows) * 0.7).toFixed(2)
...
const applicationAreaBFieldHarvestTableSubTableRow = (props) => {
    const harvest_date = props.harvest_date ? props.harvest_date.toISOString().split('T')[0] : ''
    return [
        {
            text: {
...
const applicationAreaBFieldHarvestTableSubTable = (props) => {
    ...
    let plant_date = cropHeader.plant_date ? cropHeader.plant_date.toISOString().split("T")[0] : 'No date entered'
...
const nutrientBudgetBTable = (props, img, i) => {
    let plant_date = props.headerInfo && props.headerInfo.plant_date ? props.headerInfo.plant_date.toISOString().split('T')[0] : ''
        ...
        Object.keys(fieldAppsByPlantDate).map(plantDatekey => {
            ...
            Object.keys(fieldAppsByPlantDate[plantDatekey]).map(appKey => {
                ...
                rows.push([// MainSubTable App_date/ method/ precip before during after... 
                    {
                        text: {
                            text: appEventHeader.app_date ? formatDate(appEventHeader.app_date.toISOString().split('T')[0]) : '', fontSize: 8,
                        }
                    },
                    {
                        text: {
                            ...
                            body: [
                                [ // each row is a table with  application dat table where ea row is a table of the entry
                                    { // row 1
                                        ...
                                        text: `${headerInfo.fieldtitle} - ${headerInfo.plant_date ? formatDate(headerInfo.plant_date.toISOString().split('T')[0]) : ''}: ${headerInfo.croptitle}`,
                                        fontSize: 8
                                    },
                                ],
                                [
                                                            ...
                                                            body: [
                                                                ...
                                                                [
                                                                    ...
                                                                    },
                                                                    {
                                                                        border: [false, false, false, true],
                                                                        text: {
                                                                            text: headerInfo.plant_date ? formatDate(headerInfo.plant_date.toISOString().split('T')[0]) : '', fontSize: 8,
                                                                        }
                                                                    }
                                ...
                                body: [
                                    [
                                        ...
                                        },
                                        {
                                            border: [false, false, false, true],
                                            text: {
                                                text: analysis.sample_date ? formatDate(analysis.sample_date.toISOString().split('T')[0]) : '', fontSize: 8,
                                            }
                                        },
                                        {
                                            border: [false, false, false, false],
                                    ...
                                    body: [
                                        [
                                            ...
                                            },
                                            {
                                                border: [false, false, false, true],
                                                text: {
                                                    text: props.sample_date ? formatDate(props.sample_date.toISOString().split('T')[0]) : '', fontSize: 8,
                                                }
                                            },
                                            {
                                                border: [false, false, false, false],
...
module.exports.docDef = (props, images, logo) => {
    ...
    const periodStart = dairyInfo.period_start ? formatDate(dairyInfo.period_start.toISOString().split("T")[0]) : ''
    const periodEnd = dairyInfo.period_end ? formatDate(dairyInfo.period_end.toISOString().split("T")[0]) : ''
