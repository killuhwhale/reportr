...
class UploadFieldCropAppProcessWastewateTSVModal extends Component {
  constructor(props) {
    super(props)
    this.state = {
      open: props.open,
...
export default UploadFieldCropAppProcessWastewateTSVModal = withTheme(UploadFieldCropAppProcessWastewateTSVModal);